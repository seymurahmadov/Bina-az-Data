...
public class JsoupPurchaseGardenHouse {
    public List purchaseJsoupGardenHouseData() throws IOException {

        List<PurchaseGardenHouseDto> dtoList = new ArrayList<>();
                ...
                if (categoryStringTest.equalsIgnoreCase("Bağ")) {
                    ...
                    try { //HomeArea
                        ...
                        if (matcher.find()){
                            ...
                            dto.setHomeArea(Integer.parseInt(homeArea));
                        }

                    }catch (Exception e){
                        dto.setHomeArea(Integer.parseInt("No Area"));
                    }
